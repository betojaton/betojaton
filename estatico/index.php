...
<div id="preload" class="position-fixed w-100 h-100 bg-primary">
    <div id="porcentajeCarga" class="position-absolute text-center w-100 text-white display-1 ">0%</div>
    <div id="lineaCarga" class="position-absolute w-100 bg-dark">
        <div id="rellenoCarga" class="position-absolute bg-primary"></div>
    </div>
...
<main class="container-fluid" id="main">
	<div class="row justify-content-end">
        <div class="col-12 col-lg-10 p-0 pt-lg-5">
			<!--===================================
			=            SLIDE CONTENT            =
			====================================-->
			<div class="liquid-slider" id="slider-content">
                <!--============================
                =            INICIO            =
                =============================-->
                <section id="inicio">
                    <div class="container container-page">
                        <div class="row pt-5 d-flex align-items-end">
                            <div class="col col-sm-11 col-md-8 mx-auto">
                                <!-- HEADLINE ANIMATION-->
                                <div class="caption v-middle ">
                                    <h2 class="cd-headline clip font-weight-light">
                                        <span class="blc">Hola! Soy diseñador independiente con experiencia: </span><span class="cd-words-wrapper"><b class="is-visible">DISEÑO GRAFICO</b><b>DISEÑO WEB</b><b>WORDPRESS</b></span>
                                    </h2>
                                </div>
                                <h2 class="title sr-only">Inicio</h2>
                            </div>
                            <!-- /HEADLINE ANIMATION-->
                        </div><!--/row-->
                        <div class="more-about w-75 text-left text-md-right">
                            <a href="#right" onclick="api2.setNextPanel('right');api2.updateClass($(this))" class="btn btn-outline-primary">SABER MÁS SOBRE MÍ <i class="fas fa-long-arrow-alt-right hrv-"></i></a>
                        </div>
                    </div>
                </section>
                <!--====  End of INICIO  ====-->
                ...
                =            PORTFOLIO            =
                ================================-->
                <section id="portfolio" class="rounded">
                    <?php include_once 'template-parts/portfolio.php'; ?>
                </section>
                <!--====  End of PORTFOLIO  ====-->
                ...
                =            SOBRE_MI            =
                ===============================-->
                <section id="sobre-mi" class="rounded">
                    <?php include_once 'template-parts/sobre-mi.php'; ?>
                </section>
                <!--====  End of SOBRE_MI  ====-->
                ...
                =            SERVICIOS            =
                ================================-->
                <section id="servicios" class="rounded">
                    <?php include_once 'template-parts/servicios.php'; ?>
                </section>
                <!--====  End of SERVICIOS  ====-->
...
viewBox="0 0 1820 1080" style="enable-background:new 0 0 1820 1080; position: absolute; top:0; z-index: -9; height: 100vh;" xml:space="preserve">
