...
<!--====  End of SIDEBAR  ====-->
<main id="fullpage" role="main">
    <section class="section fp-noscroll" data-anchor="page1" id="inicio">
        <!--============================
        =            INICIO            =
        =============================-->
        <div class="container container-page">
            <div class="row pt-5 d-flex align-items-end">
                <div class="col col-sm-10 col-md-8 mx-auto">
                    ...
                    <div class="caption v-middle ">
                        <h2 class="cd-headline clip font-weight-light text-wrap">
            ...
            <div class="more-about w-75 text-center">
                <a href="#page2/slide1-1" class="btn">SABER MÁS SOBRE MÍ<br><i class="fas fa-long-arrow-alt-down anim-arrow"></i></a>
            </div>
        </div>
        <!--====  End of INICIO  ====-->
    </section>
    <section class="section" data-anchor="page2" >
        ...
        =            PORTFOLIO            =
        ================================-->
        <div class="slide rounded" id="portfolio"  data-anchor="slide1-1">
        ...
        =            SOBRE_MI            =
        ===============================-->
        <div class="slide rounded" id="sobre-mi"  data-anchor="slide1-2">
            <section >
        ...
        =            SERVICIOS            =
        ================================-->
        <div class="slide rounded" id="servicios" data-anchor="slide1-3">
        ...
        =            BLOG            =
        ===========================-->
        <div class="slide rounded" id="blog" data-anchor="slide1-4">
